...
\author[]{Miguel Ángel González-Gallego \and Elena Gutiérrez \and Pedro Valero \and Alejandro Villegas} % Your name
...
\end{figure}
Tendríamos dos \textbf{atractores} \[A_1=\{(+ 1, 0)\}\]\[A_2=\{(- 1, 0)\}\]
\end{example}
\end{frame}
\begin{frame}
...
Dado un dato inicial $x_0$ consideramos un dato cercano $x_0+ε_0$, como ya hicimos en el ejemplo \ref{example:error} siendo la separación $ε_0$ extremadamente pequeña.
